...
class Cmsmagento extends \Magento\Payment\Model\Method\AbstractMethod {

    const PAYMENT_CMSMAGENTO_CODE = 'cmsmagento';
    const ACC_BIZ = 'cmsmagentobiz';
    const ACC_MONEY = 'cmsmagentomoney';

    protected $_code = self::PAYMENT_CMSMAGENTO_CODE;
     ...
     */
      public function __construct(
        ...
        \CmsmagentoPayment\Cmsmagento\Helper\Cmsmagento $helper,
    ...
    public function generateCmsmagentoHash($amount, $productInfo, $name,
            $email) {
